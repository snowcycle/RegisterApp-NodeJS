...
import { CommandResponse, Employee, EmployeeSaveRequest, EmployeeSaveResponse, ApiResponse, ActiveUser } from "./typeDefinitions";
...
export const updateEmployee = async (req: Request, res: Response): Promise<void> => {
	...
	// saveEmployee(req, res, EmployeeCreate)
};
